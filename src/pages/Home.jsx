...
function Home() {
  ...
  return (
    <MainLayout>
      <header className="flex flex-col md:flex-row md:justify-between items-center mb-8 p-6 bg-black shadow-md">
        <h1 className="text-4xl font-extrabold text-gray-900 tracking-tight mb-4 md:mb-0 mx-3">
        </h1>
        <div className="relative w-full max-w-md md:ml-6 bg-black">
          <input
            type="text"
            placeholder="Search"
            className="bg-black w-full p-4 pl-12 text-lg border border-gray-300 rounded-full shadow-lg focus:outline-none focus:ring-2 focus:ring-teal-400 transition"
            value={searchQuery}
